...
![Caret and Tilde in package.json](Screenshots/1.png)
...
-   It **locks down** the exact version that was installed at the time of `npm install`, ensuring the same versions are installed across different machines.
...
-   Bundles our code → Basic job of parcel.
    -   Bundling means it takes all our files and bundle them into one file.
